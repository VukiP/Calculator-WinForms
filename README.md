...
## How to download:
1. Download the 'Calculator.zip' folder from the 'Releases' tab, extract and open it.
2. Run the 'CalculatorWinForms.exe' file and enjoy!
...
![Interface Preview](Screenshots/InterfacePreview.png)
